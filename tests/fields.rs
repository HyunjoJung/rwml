...
fn docx_numbering_fields_compute_formatted_autonum_subset() {
    ...
    assert_eq!(fields[8].result, "cached outline number");
    assert_eq!(fields[8].computed_result.as_deref(), Some("8"));
    assert_eq!(
        fields[9].kind,
        FieldKind::Numbering("AUTONUMOUT".to_string())
    );
    assert_eq!(fields[9].instruction, "AUTONUMOUT \\* roman");
    assert_eq!(fields[9].result, "cached outline roman");
    assert_eq!(fields[9].computed_result, None);
    assert_eq!(fields[10].kind, FieldKind::Numbering("LISTNUM".to_string()));
    assert_eq!(fields[10].instruction, "LISTNUM LegalDefault \\l 2");
    assert_eq!(fields[10].result, "cached list number");
    assert_eq!(fields[10].computed_result, None);
    assert_eq!(
        fields[11].kind,
        FieldKind::Numbering("BIDIOUTLINE".to_string())
    );
    assert_eq!(fields[11].instruction, "BIDIOUTLINE");
    assert_eq!(fields[11].result, "cached bidi outline");
    ...
    assert_eq!(
        ...
        vec![
            ...
            FieldKindCount {
                kind: FieldKind::Numbering("AUTONUMOUT".to_string()),
                count: 1,
            },
            FieldKindCount {
...
fn docx_action_fields_compute_display_text_without_running_actions() {
    ...
    assert_eq!(fields[3].kind, FieldKind::Action("PRINT".to_string()));
    assert_eq!(fields[3].result, "Print instruction");
    assert_eq!(fields[3].computed_result.as_deref(), Some(""));
    ...
    assert_eq!(fields[4].result, "PostScript instruction");
    assert_eq!(fields[4].computed_result.as_deref(), Some(""));
    ...
    assert_eq!(fields[5].result, "Compact PostScript instruction");
    assert_eq!(fields[5].computed_result.as_deref(), Some(""));
    assert_eq!(fields[6].kind, FieldKind::Action("PRINT".to_string()));
    assert_eq!(fields[6].instruction, "PRINT \\z \"bad\"");
    assert_eq!(fields[6].result, "cached unsupported print");
    assert_eq!(fields[6].computed_result, None);
