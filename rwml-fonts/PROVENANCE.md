# Noto Sans KR rwml Subset Provenance

This crate bundles layout-derived subsets of Noto Sans KR Regular 400 for rwml
PDF rendering:

- `fonts/NotoSansKR-rwml-subset.ttf`: slim KS X 1001 Hangul subset.
- `fonts/NotoSansKR-rwml-subset-full.ttf`: hanja-inclusive subset.
...
punctuation ranges used by rwml layout tests.
...
```sh
pyftsubset NotoSansKR-static.ttf --text-file=ksx1001.txt --unicodes="U+0020-007E,U+00A0-00FF,U+2010-2027,U+20A9,U+3000-303F,U+3130-318F" --name-IDs='*' --notdef-outline --output-file=NotoSansKR-rwml-subset.ttf
```

```sh
pyftsubset NotoSansKR-static.ttf --text-file=ksx1001-full.txt --unicodes="U+0020-007E,U+00A0-00FF,U+2010-2027,U+20A9,U+3000-303F,U+3130-318F" --name-IDs='*' --notdef-outline --output-file=NotoSansKR-rwml-subset-full.ttf
```
