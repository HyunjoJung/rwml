...
- Opened `.docx` PDF previews now reserve line width for resolved custom and
  ...
  to three passes, so line composition stays deterministic. Alignments and
  directions outside the resolved-tab support keep parley's own breaking
  unchanged. Post-tab field
