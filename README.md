...
controls, bookmarked runs, authored footnotes/endnotes, page setup, explicit
...
- [x] **`.docx` writer** — styled authoring (named styles, rich tables with typed nested cell blocks, page setup,
      ...
      tracked insertion/deletion runs, run-level content controls, bookmarked
      runs, authored footnotes/endnotes, inline/standalone hyperlinks,
