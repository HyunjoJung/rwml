...
- `DocBuilder` provides thin model-first authoring helpers for metadata, page
  ...
  size/orientation/margins/columns/document grids/text direction/title pages, page-number restarts/formats, explicit page breaks, next/even/odd section breaks that snapshot
