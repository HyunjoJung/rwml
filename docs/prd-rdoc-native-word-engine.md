...
- comments, fields, tracked insertions/deletions, charts, and content controls as
  builder surfaces;
- chart authoring should cover bar, stacked bar, 100% stacked bar, 3-D bar, stacked 3-D bar, column, stacked column, 100% stacked column, 3-D column, stacked 3-D column, 100% stacked 3-D column,
