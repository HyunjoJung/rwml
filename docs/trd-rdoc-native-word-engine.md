...
simple text tables, width-aware, aligned, fixed-layout, indented, and border-colored rich tables, explicit
...
page size/orientation/margins/columns/text direction/title pages, page-number restarts/formats,
...
- classify `PAGEREF` as a named field kind, compute page numbers only when the
  ...
  `body/sectPr` page-number defaults, source-persisted
