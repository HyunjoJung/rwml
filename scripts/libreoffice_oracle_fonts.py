...
try:
    from render_oracle_contract import _read_bounded_regular_file as _read_regular_file
except ModuleNotFoundError:
    from scripts.render_oracle_contract import _read_bounded_regular_file as _read_regular_file
