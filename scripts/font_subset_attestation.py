...
try:
    ...
    from scripts import font_subset_worker as worker
    from scripts import libreoffice_container as runtime
    from scripts.libreoffice_oracle_fonts import _positive_int, _safe_text, _sha256
    from scripts.render_oracle_contract import _assert_path_neutral, _load_json, _require_exact_keys
